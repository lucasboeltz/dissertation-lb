...
(assert (! (not (intersection u1 v1 y w3)) :named Q101))
(assert (! (not (intersection u1 v1 w3 w2)) :named Q102))

(assert (! (not (inside z w2 y u1)) :named Q201))
(assert (! (not (inside z w2 y v1)) :named Q202))
