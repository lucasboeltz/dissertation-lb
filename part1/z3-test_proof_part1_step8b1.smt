...
(assert (! (intersection u1 v1 y2 z3) :named Q1))

(assert (! (intersection u1 v1 y4 z3) :named Q11))

(assert (! (intersection u1 v1 y4 z4) :named Q21))
(assert (! (inside y2 y4 z3 z4) :named Q22))

(assert (! (inside y2 y4 z3 w5) :named Q31))


(assert (! (not (intersection u1 v1 y4 w5)) :named Q101))
(assert (! (not (intersection u1 v1 w5 z4)) :named Q102))

(assert (! (not (inside y2 y4 z3 u1)) :named Q201))
(assert (! (not (inside y2 y4 z3 v1)) :named Q202))
