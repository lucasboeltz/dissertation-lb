...
(assert (! (inside w3 y2 z3 y3) :named Q23))

(assert (! (deleting y3 z3 w5 x5) :named Q31))
(assert (! (deleting y3 z3 x5 w5) :named Q32))


(assert (! (not (deleting y2 z3 w5 x3)) :named Q101))
(assert (! (not (deleting y2 z3 x5 x3)) :named Q102))
(assert (! (not (deleting y2 z3 w5 x5)) :named Q103))
(assert (! (not (deleting y2 z3 x5 w5)) :named Q104))

(assert (! (not (F w3 x3)) :named Q201))

(assert (! (not (intersection w3 x3 y3 z3)) :named Q301))
(assert (! (not (intersection w3 x3 w5 z3)) :named Q311))

(assert (! (not (inside w3 y2 z3 w5)) :named Q401))
(assert (! (not (inside w3 y2 z3 x5)) :named Q402))
