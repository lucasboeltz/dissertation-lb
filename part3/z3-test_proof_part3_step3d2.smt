...
(assert (! (intersection u1 v1 y7 z7) :named Q51))
(assert (! (intersection y4 z3 y7 z7) :named Q52))


(assert (! (not (intersection y4 z5 y7 z7)) :named Q101))
