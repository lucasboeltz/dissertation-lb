...
(assert (! (deleting y8 z7 z9 x8) :named Q51))
(assert (! (intersection u1 v1 y8 z9) :named Q52))
(assert (! (inside y2 y4 z3 z9) :named Q53))

(assert (! (E y10 z9) :named Q61))
(assert (! (intersection u1 v1 y10 z9) :named Q62))
(assert (! (inside z3 z5 y4 y10) :named Q63))
(assert (! (inside z7 z9 y8 y10) :named Q64))

(assert (! (deleting y10 z9 w10 x10) :named Q71))
...
(assert (! (not (inside y2 y4 z3 w10)) :named Q301))
