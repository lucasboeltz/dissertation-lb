...
(assert (! (E y3 z3) :named Q21))
(assert (! (intersection u1 v1 y3 z3) :named Q22))
(assert (! (inside z3 z1 y2 y3) :named Q23))

(assert (! (deleting y3 z3 w4 x4) :named Q31))


(assert (! (not (deleting y2 z3 w4 x4)) :named Q101))

(assert (! (not (deleting y3 z3 x4 w4)) :named Q201))
(assert (! (not (deleting y3 z3 y2 x4)) :named Q211))
(assert (! (not (inside z3 z1 y2 w4)) :named Q221))

(assert (! (not (intersection u1 v1 y3 w4)) :named Q301))
