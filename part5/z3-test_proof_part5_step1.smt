...
(assert (! (=> (F w1 x1) (left u1 v1 w1)) :named W1))
(assert (! (=> (F w1 x1) (left v1 u1 x1)) :named W2))
(assert (! (=> (F w1 x1) (left w1 x1 v1)) :named W3))
(assert (! (=> (F w1 x1) (left x1 w1 u1)) :named W4))
(assert (! (E u1 v1) :named W5))
(assert (! (F w1 x1) :named W6))



;w1x1 is the edge with intersection point closest to v1 intersecting with u1v1
(assert (! (forall ((y point) (z point)) (=> (and (F y z) (intersection u1 v1 y z)) (not (intersection u1 w1 y z)))) :named X1))
(assert (! (forall ((y point) (z point)) (=> (and (F y z) (intersection u1 v1 y z)) (not (intersection u1 x1 y z)))) :named X2))
(assert (! (forall ((y point) (z point)) (=> (and (F y z) (intersection u1 v1 y z)) (not (inside u1 x1 w1 y)))) :named X3))
(assert (! (forall ((y point) (z point)) (=> (and (F y z) (intersection u1 v1 y z)) (not (inside u1 x1 w1 z)))) :named X4))
