...
(assert (! (E y5 z5) :named Q21))
(assert (! (intersection u1 v1 y5 z5) :named Q22))
(assert (! (inside z3 z5 y4 y5) :named Q23))

(assert (! (deleting y5 z5 w6 x6) :named Q31))
(assert (! (intersection u1 v1 w6 z5) :named Q32))

(assert (! (inside z3 z5 y4 w6) :named Q41))
(assert (! (intersection y4 z3 w6 z5) :named Q42))


(assert (! (not (F u1 v1)) :named Q101))

(assert (! (not (F z5 x4)) :named Q201))
