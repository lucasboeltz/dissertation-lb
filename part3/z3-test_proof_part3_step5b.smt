...
(assert (! (E y4 z5) :named Q31))
(assert (! (intersection u1 v1 y4 z5) :named Q32))
(assert (! (inside y4 y2 z3 z5) :named Q33))

(assert (! (E y6 z5) :named Q41))
(assert (! (intersection u1 v1 y6 z5) :named Q42))
(assert (! (inside z3 z1 y2 y6) :named Q43))

(assert (! (E y6 z7) :named Q51))
(assert (! (intersection u1 v1 y6 z7) :named Q52))
(assert (! (inside y4 y6 z5 z7) :named Q53))

(assert (! (deleting y6 z7 w7 x7) :named Q61))


(assert (! (not (F w7 x7)) :named Q101))

(assert (! (not (inside z3 z1 y2 w7)) :named Q201))
