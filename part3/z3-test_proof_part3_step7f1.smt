...
(assert (! (deleting y8 z7 z9 x8) :named Q31))
(assert (! (intersection u1 v1 y8 z9) :named Q32))

(assert (! (E y10 z9) :named Q41))
(assert (! (intersection u1 v1 y10 z9) :named Q42))
(assert (! (inside z9 z7 y8 y10) :named Q43))

(assert (! (deleting y10 z9 w10 x10) :named Q51))

(assert (! (intersection y2 z1 y10 w10) :named Q61))
