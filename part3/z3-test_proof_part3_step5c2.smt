...
(declare-const z1 point)
(declare-const y2 point)
(declare-const z3 point)
(declare-const y4 point)
(declare-const y6 point)
(declare-const z7 point)
(declare-const w7 point)
(declare-const x7 point)
(declare-const y8 point)
(declare-const z9 point)
(declare-const w10 point)
(declare-const x10 point)
...
(assert (! (E y2 z1) :named Q2))
(assert (! (intersection u1 v1 y2 z1) :named Q3))

(assert (! (E z1 z3) :named Q11))
(assert (! (E y2 z3) :named Q12))
(assert (! (intersection u1 v1 y2 z3) :named Q13))

(assert (! (E y4 z3) :named Q21))
(assert (! (intersection u1 v1 y4 z3) :named Q22))
(assert (! (inside z3 z1 y2 y4) :named Q23))

(assert (! (E y6 z3) :named Q31))
(assert (! (intersection u1 v1 y6 z3) :named Q32))
(assert (! (inside z3 z1 y2 y6) :named Q33))

(assert (! (E y6 z7) :named Q41))
(assert (! (intersection u1 v1 y6 z7) :named Q42))
(assert (! (inside z3 z1 y2 z7) :named Q43))
(assert (! (inside y4 y2 z3 z7) :named Q44))

(assert (! (deleting y6 z7 w7 x7) :named Q51))
(assert (! (intersection u1 v1 w7 z7) :named Q52))
(assert (! (inside z3 z1 y2 w7) :named Q53))

(assert (! (E y8 z7) :named Q61)) 
(assert (! (intersection u1 v1 y8 z7) :named Q62))
(assert (! (inside w7 y6 z7 y8) :named Q63))

(assert (! (E y8 z9) :named Q71)) 
(assert (! (intersection u1 v1 y8 z9) :named Q72))
(assert (! (inside y4 y2 z3 z9) :named Q73))
(assert (! (inside y8 y6 z7 z9) :named Q74))

(assert (! (deleting y8 z9 w10 x10) :named Q81))


(assert (! (not (intersection y4 z3 y6 z7)) :named Q101))
(assert (! (not (intersection y4 z3 y8 z7)) :named Q102))
(assert (! (not (intersection y4 z3 y8 z9)) :named Q103))

(assert (! (not (F w10 x10)) :named Q201))

(assert (! (not (inside z3 z1 y2 w10)) :named Q301))
