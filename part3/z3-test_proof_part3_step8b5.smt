...
(assert (! (E y5 z5) :named Q31))
(assert (! (intersection u1 v1 y5 z5) :named Q32))
(assert (! (inside z3 z5 y4 y5) :named Q33))

(assert (! (deleting y5 z5 w7 x7) :named Q41))
(assert (! (intersection u1 v1 w7 z5) :named Q42))

(assert (! (inside z3 z5 y4 w7) :named Q51))
(assert (! (intersection y4 z3 w7 z5) :named Q52))
...
(assert (! (not (intersection w4 x4 y4 z5)) :named Q301))
