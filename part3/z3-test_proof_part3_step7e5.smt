...
(assert (! (E y6 z5) :named Q21))
(assert (! (intersection u1 v1 y2 z5) :named Q22))
(assert (! (intersection u1 v1 y6 z5) :named Q23))
(assert (! (inside z1 z3 y2 y6) :named Q24))

(assert (! (deleting y6 z5 w6 x6) :named Q31))
(assert (! (intersection u1 v1 y6 w6) :named Q32))

(assert (! (E y6 z7) :named Q41))
(assert (! (intersection u1 v1 y6 z7) :named Q42))
(assert (! (inside z5 w6 y6 z7) :named Q43))

(assert (! (E y8 z7) :named Q51))
(assert (! (intersection u1 v1 y8 z7) :named Q52))
(assert (! (inside z5 z7 y6 y8) :named Q53))

(assert (! (deleting y8 z7 w9 x9) :named Q61))
(assert (! (intersection u1 v1 y8 w9) :named Q62))

(assert (! (inside w9 z7 y8 z8) :named Q71))

(assert (! (intersection y2 z1 y8 z8) :named Q81))



(assert (! (not (intersection y2 z1 y6 z5)) :named Q101))
(assert (! (not (intersection y2 z1 y6 z7)) :named Q102))
(assert (! (not (intersection y2 z1 y8 z7)) :named Q103))

(assert (! (not (intersection y2 z3 y6 z5)) :named Q111))
(assert (! (not (intersection y2 z3 y6 z7)) :named Q112))
(assert (! (not (intersection y2 z3 y8 z7)) :named Q113))

(assert (! (not (F w6 x6)) :named Q201))

(assert (! (not (F w9 x9)) :named Q301))
