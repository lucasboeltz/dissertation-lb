...
(assert (! (inside z3 w4 y4 z5) :named Q23))

(assert (! (deleting y4 z5 w6 x6) :named Q31))
(assert (! (deleting y4 z5 x6 w6) :named Q32))
(assert (! (intersection u1 v1 w6 z5) :named Q33))
(assert (! (intersection u1 v1 x6 z5) :named Q34))
(assert (! (inside z3 z5 y4 w6) :named Q35))

(assert (! (deleting w6 z5 w7 x7) :named Q41))

(assert (! (deleting w7 z5 w6 x6) :named Q51))



(assert (! (not (F w4 x4)) :named Q101))

(assert (! (not (inside z3 z5 y4 x6)) :named Q201))
