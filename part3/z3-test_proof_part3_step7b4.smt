...
(assert (! (deleting y4 z4 x6 w6) :named Q42))

(assert (! (intersection w4 x4 y4 w6) :named Q41))


(assert (! (not (F w4 x4)) :named Q101))

(assert (! (not (deleting y4 z3 w6 x4)) :named Q201))
(assert (! (not (deleting y4 z3 x6 x4)) :named Q202))
(assert (! (not (deleting y4 z3 w6 x6)) :named Q203))
(assert (! (not (deleting y4 z3 x6 w6)) :named Q204))
