...
(assert (! (intersection u1 v1 w7 z7) :named Q31))

(assert (! (inside w7 y6 z7 y7) :named Q41))

(assert (! (intersection y2 z3 y7 z7) :named Q51))


(assert (! (not (intersection y2 z3 y6 z7)) :named Q101))
(assert (! (not (intersection y2 z3 w7 z7)) :named Q102))

(assert (! (not (intersection y4 z3 y6 z7)) :named Q111))
(assert (! (not (intersection y4 z3 w7 z7)) :named Q112))


(assert (! (not (inside w7 y6 z7 y2)) :named Q201))
