...
(assert (! (E y2 z2) :named Q31))
(assert (! (intersection u1 v1 y2 z2) :named Q32))
(assert (! (inside w3 w2 y2 z2) :named Q33))
...
(assert (! (not (E z1 z2)) :named Q301))

(assert (! (not (= z1 z2)) :named Q311))
