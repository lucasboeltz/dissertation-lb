...
;all edges deleting y10z9 are type Y edges
(assert (! (forall ((w point) (x point)) (=> (deleting y10 z9 w x) (or (intersection u1 v1 z9 w) (deleting y10 z9 x w)))) :named U17))
(assert (! (forall ((w point) (x point)) (=> (deleting y10 z9 w x) (or (intersection u1 v1 z9 w) (intersection u1 v1 z9 x)))) :named U18))
...
(assert (! (E y8 z7) :named Q21))
(assert (! (intersection u1 v1 y2 z7) :named Q22))
(assert (! (intersection u1 v1 y8 z7) :named Q23))
(assert (! (inside z1 z3 y2 y8) :named Q24))

(assert (! (deleting y8 z7 w8 x8) :named Q31))
(assert (! (intersection u1 v1 y8 w8) :named Q32))

(assert (! (E y8 z7) :named Q41))
(assert (! (intersection u1 v1 y8 z9) :named Q42))
(assert (! (inside w8 z7 y8 z9) :named Q43))

(assert (! (E y10 z9) :named Q51))
(assert (! (intersection u1 v1 y10 z9) :named Q52))
(assert (! (inside z9 z7 y8 y10) :named Q53))

(assert (! (deleting y10 z9 w11 x11) :named Q61))

(assert (! (intersection y2 z1 y10 w11) :named Q71))



(assert (! (not (intersection y2 z1 y8 z7)) :named Q101))
(assert (! (not (intersection y2 z1 y8 z9)) :named Q102))
(assert (! (not (intersection y2 z1 y10 z9)) :named Q103))

(assert (! (not (intersection y2 z3 y8 z7)) :named Q111))
(assert (! (not (intersection y2 z3 y8 z9)) :named Q112))
(assert (! (not (intersection y2 z3 y10 z9)) :named Q113))

(assert (! (not (F w8 x8)) :named Q201))

(assert (! (not (F w11 x11)) :named Q301))
