...
(assert (! (intersection u1 v1 w3 z3) :named Q22))

(assert (! (inside y2 w3 z3 u1) :named Q31))


(assert (! (not (inside z3 z1 y2 u1)) :named Q101))
(assert (! (not (inside z3 z1 y2 v1)) :named Q102))
(assert (! (not (inside z1 z3 y2 u1)) :named Q103))
(assert (! (not (inside z1 z3 y2 v1)) :named Q104))

(assert (! (not (deleting y2 z3 x3 w3)) :named Q201))
