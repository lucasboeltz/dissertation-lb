...
(assert (! (E y6 z5) :named Q31))
(assert (! (intersection u1 v1 y6 z5) :named Q32))
(assert (! (inside z3 z5 y4 y6) :named Q33))

(assert (! (E y6 z7) :named Q41))
(assert (! (intersection u1 v1 y6 z7) :named Q42))
(assert (! (inside y2 y4 z3 z7) :named Q43))

(assert (! (E y8 z7) :named Q51))
(assert (! (intersection u1 v1 y8 z7) :named Q52))
(assert (! (inside z7 z5 y6 y8) :named Q53))

(assert (! (deleting y8 z7 w8 x8) :named Q61))


(assert (! (not (F w8 x8)) :named Q101))

(assert (! (not (inside y2 y4 z3 w8)) :named Q201))
