...
(declare-const w9 point)
(declare-const x9 point)
...
(assert (! (deleting y6 z7 y8 x7) :named Q51))
(assert (! (intersection u1 v1 y8 z7) :named Q52))
(assert (! (inside z3 z1 y2 y8) :named Q53))

(assert (! (E y8 z9) :named Q61))
(assert (! (intersection u1 v1 y8 z9) :named Q62))
(assert (! (inside y4 y2 z3 z9) :named Q63))
(assert (! (inside y8 y6 z7 z9) :named Q64))

(assert (! (deleting y8 z9 w9 x9) :named Q71))
...
(assert (! (not (F w9 x9)) :named Q201))

(assert (! (not (inside z3 z1 y2 w9)) :named Q301))
