...
(assert (! (forall ((w point) (x point)) (=> (deleting y10 z11 w x) (or (intersection u1 v1 w z11) (deleting y10 z11 x w)))) :named U19))
(assert (! (forall ((w point) (x point)) (=> (deleting y10 z11 w x) (or (intersection u1 v1 w z11) (intersection u1 v1 x z11)))) :named U20))
...
(assert (! (E y8 z3) :named Q31))
(assert (! (intersection u1 v1 z3 y8) :named Q32))
(assert (! (inside z3 z1 y2 y8) :named Q33))

(assert (! (E y8 z9) :named Q41))
(assert (! (intersection u1 v1 y8 z9) :named Q42))
(assert (! (inside z3 z1 y2 z9) :named Q43))
(assert (! (inside y4 y2 z3 z9) :named Q44))

(assert (! (E y10 z9) :named Q51))
(assert (! (intersection u1 v1 z9 y10) :named Q52))
(assert (! (inside z3 z1 y2 y10) :named Q53))

(assert (! (E y10 z11) :named Q61))
(assert (! (intersection u1 v1 y10 z11) :named Q62))
(assert (! (inside y4 y2 z3 z11) :named Q63))
(assert (! (inside y8 y10 z9 z11) :named Q64))

(assert (! (deleting y10 z11 w11 x11) :named Q71))


(assert (! (not (intersection y4 z3 y8 z9)) :named Q101))
(assert (! (not (intersection y4 z3 y10 z9)) :named Q102))
(assert (! (not (intersection y4 z3 y10 z11)) :named Q103))

(assert (! (not (F w11 x11)) :named Q201))

(assert (! (not (inside z3 z1 y2 w11)) :named Q301))
