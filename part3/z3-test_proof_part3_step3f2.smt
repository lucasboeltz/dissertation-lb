...
(declare-const z11 point)
(declare-const w12 point)
(declare-const x12 point)
...
;all edges deleting y10z11 are type Y edges
(assert (! (forall ((w point) (x point)) (=> (deleting y10 z11 w x) (or (intersection u1 v1 z11 w) (deleting y10 z11 x w)))) :named U19))
(assert (! (forall ((w point) (x point)) (=> (deleting y10 z11 w x) (or (intersection u1 v1 z11 w) (intersection u1 v1 z11 x)))) :named U20))
...
(assert (! (E y8 z9) :named Q21))
(assert (! (intersection u1 v1 y8 z3) :named Q22))
(assert (! (intersection u1 v1 y8 z9) :named Q23))
(assert (! (inside y4 y2 z3 z9) :named Q24))

(assert (! (deleting y8 z9 w9 x9) :named Q31))
(assert (! (intersection u1 v1 w9 z9) :named Q32))

(assert (! (E y10 z9) :named Q41))
(assert (! (intersection u1 v1 y10 z9) :named Q42))
(assert (! (inside y8 w9 z9 y10) :named Q43))

(assert (! (E y10 z11) :named Q51))
(assert (! (intersection u1 v1 y10 z11) :named Q52))
(assert (! (inside y8 y10 z9 z11) :named Q53))

(assert (! (deleting y10 z11 w12 x12) :named Q61))

(assert (! (intersection y2 z3 w12 z11) :named Q71))


(assert (! (not (intersection y2 z3 y8 z9)) :named Q101))
(assert (! (not (intersection y2 z3 y10 z9)) :named Q102))
(assert (! (not (intersection y2 z3 y10 z11)) :named Q103))

(assert (! (not (intersection y4 z3 y8 z9)) :named Q111))
(assert (! (not (intersection y4 z3 y10 z9)) :named Q112))
(assert (! (not (intersection y4 z3 y10 z11)) :named Q113))

(assert (! (not (F w9 x9)) :named Q201))

(assert (! (not (F w12 x12)) :named Q301))
