...
(assert (! (deleting y4 z3 z5 x4) :named Q11))
(assert (! (intersection u1 v1 y4 z5) :named Q12))

(assert (! (deleting y4 z5 w5 x5) :named Q21))
(assert (! (deleting y4 z5 x5 w5) :named Q22))
(assert (! (intersection u1 v1 w5 z5) :named Q23))
(assert (! (intersection u1 v1 x5 z5) :named Q24))
(assert (! (inside z3 z5 y4 w5) :named Q25))

(assert (! (deleting w5 z5 w6 x6) :named Q31))

(assert (! (deleting w6 z5 w5 x5) :named Q41))



(assert (! (not (F z5 x4)) :named Q101))

(assert (! (not (inside z3 z5 y4 x5)) :named Q201))
