...
(assert (! (deleting w3 z3 y4 x4) :named Q21))
(assert (! (intersection u1 v1 y4 z3) :named Q22))

(assert (! (E y4 z4) :named Q31))
(assert (! (intersection u1 v1 y4 z4) :named Q32))
(assert (! (inside y2 y4 z3 z4) :named Q33))

(assert (! (deleting y4 z4 z3 x6) :named Q41))


(assert (! (not (deleting w3 z3 x4 y4)) :named Q101))

(assert (! (not (deleting y4 z4 x6 z3)) :named Q201))
