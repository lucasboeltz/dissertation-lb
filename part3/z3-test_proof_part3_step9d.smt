...
;all edges deleting y12z11 are type Z edges
(assert (! (forall ((w point) (x point)) (=> (deleting y12 z11 w x) (or (intersection u1 v1 y12 w) (deleting y12 z11 x w)))) :named U21))
(assert (! (forall ((w point) (x point)) (=> (deleting y12 z11 w x) (or (intersection u1 v1 y12 w) (intersection u1 v1 y12 x)))) :named U22))
...
(assert (! (E y4 z9) :named Q31))
(assert (! (intersection u1 v1 y4 z9) :named Q32))
(assert (! (inside y2 y4 z3 z9) :named Q33))

(assert (! (E y10 z9) :named Q41))
(assert (! (intersection u1 v1 y10 z9) :named Q42))
(assert (! (inside y2 y4 z3 y10) :named Q43))
(assert (! (inside z3 z5 y4 y10) :named Q44))

(assert (! (E y10 z11) :named Q51))
(assert (! (intersection u1 v1 y10 z11) :named Q52))
(assert (! (inside y2 y4 z3 z11) :named Q53))

(assert (! (E y12 z11) :named Q61))
(assert (! (intersection u1 v1 y12 z11) :named Q62))
(assert (! (inside z3 z5 y4 y12) :named Q63))
(assert (! (inside z11 z9 y10 y12) :named Q64))

(assert (! (deleting y12 z11 w12 x12) :named Q71))


(assert (! (not (intersection y4 z5 y10 z9)) :named Q101))
(assert (! (not (intersection y4 z5 y10 z11)) :named Q102))
(assert (! (not (intersection y4 z5 y12 z11)) :named Q103))

(assert (! (not (F w12 x12)) :named Q201))

(assert (! (not (inside y2 y4 z3 w12)) :named Q301))
