...
(assert (! (not (deleting y2 z3 w4 x4)) :named Q102))
(assert (! (not (deleting y2 z3 x4 x3)) :named Q103))
(assert (! (not (deleting y2 z3 x4 w4)) :named Q104))

(assert (! (not (F w3 x3)) :named Q201))

(assert (! (not (inside y2 w3 z3 w4)) :named Q301))
(assert (! (not (inside w3 y2 z3 w4)) :named Q302))
(assert (! (not (inside y2 w3 z3 x4)) :named Q303))
(assert (! (not (inside w3 y2 z3 x4)) :named Q304))
