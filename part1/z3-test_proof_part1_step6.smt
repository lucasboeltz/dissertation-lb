...
(assert (! (deleting y2 w3 w4 x4) :named Q31))


(assert (! (not (deleting y2 z1 x3 w3)) :named Q101))
(assert (! (not (deleting y2 z1 x4 w4)) :named Q111))

(assert (! (not (deleting y2 w2 x3 w3)) :named Q201))

(assert (! (not (deleting y2 w3 x4 w4)) :named Q301))

(assert (! (not (intersection u1 v1 y2 w4)) :named Q401))
(assert (! (not (intersection u1 v1 w4 w3)) :named Q402))
