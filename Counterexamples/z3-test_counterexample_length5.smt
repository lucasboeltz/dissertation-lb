...
(assert (! (deleting u2 y u1 v1) :named Q1))
(assert (! (deleting u3 y u2 v2) :named Q2))
(assert (! (deleting u4 y u3 v3) :named Q3))
(assert (! (deleting u5 y u4 v4) :named Q4))
(assert (! (deleting u1 y u5 v5) :named Q5))


(assert (! (not (E v1 y)) :named Q101))
(assert (! (not (E v2 y)) :named Q102))
(assert (! (not (E v3 y)) :named Q103))
(assert (! (not (E v4 y)) :named Q104))
(assert (! (not (E v5 y)) :named Q105))
