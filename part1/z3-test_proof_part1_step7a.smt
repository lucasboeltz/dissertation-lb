...
(assert (! (intersection u1 v1 y2 z2) :named Q31))
(assert (! (inside y2 w2 w3 z2) :named Q32))

(assert (! (deleting y2 z2 w5 x5) :named Q41))


(assert (! (not (deleting y2 z1 x3 w3)) :named Q101))
(assert (! (not (deleting y2 z1 x5 w5)) :named Q111))

(assert (! (not (deleting y2 w2 x3 w3)) :named Q201))

(assert (! (not (deleting y2 z2 x5 w5)) :named Q301))

(assert (! (not (intersection u1 v1 y2 w5)) :named Q401))
(assert (! (not (intersection u1 v1 w5 z2)) :named Q402))
