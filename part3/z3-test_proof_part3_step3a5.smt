...
(assert (! (deleting w3 z3 x4 w4) :named Q22))
(assert (! (intersection u1 v1 w4 z3) :named Q23))
(assert (! (intersection u1 v1 x4 z3) :named Q24))
(assert (! (inside w3 y2 z3 w4) :named Q25))

(assert (! (deleting w4 z3 w5 x5) :named Q31))

(assert (! (deleting w5 z3 w4 x4) :named Q41))



(assert (! (not (deleting y2 z3 w4 x3)) :named Q101))

(assert (! (not (deleting y2 z3 x4 x3)) :named Q111))
(assert (! (not (deleting y2 z3 x4 x5)) :named Q112))

(assert (! (not (F w3 x3)) :named Q201))

(assert (! (not (inside w3 y2 z3 x4)) :named Q301))
