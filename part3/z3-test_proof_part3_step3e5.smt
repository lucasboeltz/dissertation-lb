...
(assert (! (forall ((w point) (x point)) (=> (deleting y2 z3 w x) (or (intersection u1 v1 z3 w) (deleting y2 z3 x w)))) :named U3))
(assert (! (forall ((w point) (x point)) (=> (deleting y2 z3 w x) (or (intersection u1 v1 z3 w) (intersection u1 v1 z3 x)))) :named U4))
...
(assert (! (forall ((w point) (x point)) (=> (deleting y6 z7 w x) (or (intersection u1 v1 z7 w) (deleting y6 z7 x w)))) :named U11))
(assert (! (forall ((w point) (x point)) (=> (deleting y6 z7 w x) (or (intersection u1 v1 z7 w) (intersection u1 v1 z7 x)))) :named U12))
...
(assert (! (forall ((w point) (x point)) (=> (deleting y8 z9 w x) (or (intersection u1 v1 z9 w) (deleting y8 z9 x w)))) :named U15))
(assert (! (forall ((w point) (x point)) (=> (deleting y8 z9 w x) (or (intersection u1 v1 z9 w) (intersection u1 v1 z9 x)))) :named U16))
...
(assert (! (E y6 z7) :named Q21))
(assert (! (intersection u1 v1 y6 z3) :named Q22))
(assert (! (intersection u1 v1 y6 z7) :named Q23))
(assert (! (inside y4 y2 z3 z7) :named Q24))

(assert (! (deleting y6 z7 w7 x7) :named Q31))
(assert (! (intersection u1 v1 w7 z7) :named Q32))

(assert (! (E y8 z7) :named Q41))
(assert (! (intersection u1 v1 y8 z7) :named Q42))
(assert (! (inside w7 y6 z7 y8) :named Q43))

(assert (! (E y8 z9) :named Q51))
(assert (! (intersection u1 v1 y8 z9) :named Q52))
(assert (! (inside y8 y6 z7 z9) :named Q53))

(assert (! (deleting y8 z9 w10 x10) :named Q61))
(assert (! (intersection u1 v1 w10 z9) :named Q62))

(assert (! (inside y8 w10 z9 y9) :named Q71))

(assert (! (intersection y2 z3 y9 z9) :named Q81))


(assert (! (not (intersection y2 z3 y6 z7)) :named Q101))
(assert (! (not (intersection y2 z3 y8 z7)) :named Q102))
(assert (! (not (intersection y2 z3 y8 z9)) :named Q103))

(assert (! (not (intersection y4 z3 y6 z7)) :named Q111))
(assert (! (not (intersection y4 z3 y8 z7)) :named Q112))
(assert (! (not (intersection y4 z3 y8 z9)) :named Q113))

(assert (! (not (F w7 x7)) :named Q201))

(assert (! (not (F w10 x10)) :named Q301))
