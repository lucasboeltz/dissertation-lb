...
(assert (! (E z3 z5) :named Q11))
(assert (! (E y4 z5) :named Q12))
...
(assert (! (not (inside z3 z5 y4 w5)) :named Q201))
(assert (! (not (inside z3 z5 y4 x5)) :named Q202))
(assert (! (not (inside z5 z3 y4 w5)) :named Q203))
(assert (! (not (inside z5 z3 y4 x5)) :named Q204))
