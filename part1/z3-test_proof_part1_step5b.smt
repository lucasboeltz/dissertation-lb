...
(assert (! (inside z1 w2 y2 z2) :named Q21))
(assert (! (intersection u1 v1 y2 z2) :named Q22))

(assert (! (deleting y2 z2 w4 x4) :named Q31))


(assert (! (not (deleting y2 z1 x4 w4)) :named Q101))

(assert (! (not (deleting y2 z2 x4 w4)) :named Q201))

(assert (! (not (intersection u1 v1 y2 w4)) :named Q301))
(assert (! (not (intersection u1 v1 w4 z2)) :named Q302))
