...
(declare-const u2 point)
(declare-const u3 point)
(declare-const u4 point)
(declare-const u5 point)
(declare-const u6 point)
(declare-const v1 point)
(declare-const v2 point)
(declare-const v3 point)
(declare-const v4 point)
(declare-const v5 point)
(declare-const v6 point)
...
(assert (! (forall ((u point) (v point) (w point) (x point)) (=> (and (E u v) (E v w) (E w u) (V x) (inside u v w x )) (or (E u x) (E v x)))) :named C1))
...
(assert (! (deleting u1 u2 u3 v3) :named Q1))
(assert (! (deleting u2 u3 u4 v4) :named Q2))
(assert (! (deleting u3 u4 u5 v5) :named Q3))
(assert (! (deleting u4 u5 u6 v6) :named Q4))
(assert (! (deleting u5 u6 u1 v1) :named Q5))
(assert (! (deleting u6 u1 u2 v2) :named Q6))


(assert (! (not (E u2 v3)) :named Q101))
(assert (! (not (E u3 v4)) :named Q102))
(assert (! (not (E u4 v5)) :named Q103))
(assert (! (not (E u5 v6)) :named Q104))
(assert (! (not (E u6 v1)) :named Q105))
(assert (! (not (E u1 v2)) :named Q106))
