...
(assert (! (deleting y3 z3 x4 w4) :named Q32))

(assert (! (intersection u1 v1 w4 z3) :named Q41))
(assert (! (inside z3 z1 y2 w4) :named Q42))

(assert (! (intersection y2 z1 w4 z3) :named Q51))


(assert (! (not (intersection y2 z1 y3 z3)) :named Q101))
