...
(assert (! (intersection u1 v1 y8 z5) :named Q42))
(assert (! (intersection u1 v1 y8 z9) :named Q43))
(assert (! (inside y4 y6 z5 z9) :named Q44))

(assert (! (deleting y8 z9 w9 x9) :named Q51))

(assert (! (inside y8 w9 z9 y4) :named Q61))


(assert (! (not (intersection y4 z5 y8 z9)) :named Q101))

(assert (! (not (intersection y6 z5 y8 z9)) :named Q111))
