...
;all edges deleting y10z11 are type Z edges
(assert (! (forall ((w point) (x point)) (=> (deleting y10 z11 w x) (or (intersection u1 v1 y10 w) (deleting y10 z11 x w)))) :named U19))
(assert (! (forall ((w point) (x point)) (=> (deleting y10 z11 w x) (or (intersection u1 v1 y10 w) (intersection u1 v1 y10 x)))) :named U20))
...
(assert (! (deleting y8 z9 y10 x9) :named Q31))
(assert (! (intersection u1 v1 y10 z9) :named Q32))

(assert (! (E y10 z9) :named Q41))
(assert (! (intersection u1 v1 y10 z11) :named Q42))
(assert (! (inside y8 y10 z9 z11) :named Q43))

(assert (! (deleting y10 z11 w11 x11) :named Q51))

(assert (! (intersection y2 z3 w11 z11) :named Q61))
...
(assert (! (not (F y10 x9)) :named Q201))
