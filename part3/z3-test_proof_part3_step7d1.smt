...
(assert (! (inside z1 z3 y2 y4) :named Q23))
...
(assert (! (inside z5 z3 y4 y6) :named Q43))

(assert (! (deleting y6 z5 w6 x6) :named Q51))

(assert (! (intersection y2 z1 y6 w6) :named Q61))


(assert (! (not (intersection y2 z1 y4 z5)) :named Q101))
(assert (! (not (intersection y2 z1 y6 z5)) :named Q102))

(assert (! (not (intersection y2 z3 y4 z5)) :named Q111))
(assert (! (not (intersection y2 z3 y6 z5)) :named Q112))
