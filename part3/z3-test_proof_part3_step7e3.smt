...
(assert (! (intersection u1 v1 y4 z7) :named Q42))
(assert (! (intersection u1 v1 y8 z7) :named Q43))
(assert (! (inside z5 z3 y4 y8) :named Q44))

(assert (! (deleting y8 z7 w8 x8) :named Q51))

(assert (! (inside w8 z7 y8 z3) :named Q61))



(assert (! (not (intersection y4 z3 y8 z7)) :named Q101))

(assert (! (not (intersection y4 z5 y8 z7)) :named Q111))
