...
(declare-const z7 point)
(declare-const y8 point)
(declare-const w8 point)
(declare-const x8 point)
(declare-const z9 point)
(declare-const y10 point)
(declare-const w11 point)
(declare-const x11 point)
...
;all edges deleting y2z1 are type Z edges
;(assert (! (forall ((w point) (x point)) (=> (deleting y2 z1 w x) (or (intersection u1 v1 y2 w) (deleting y2 z1 x w)))) :named U1))
;(assert (! (forall ((w point) (x point)) (=> (deleting y2 z1 w x) (or (intersection u1 v1 y2 w) (intersection u1 v1 y2 x)))) :named U2))
...
;all edges deleting y5z6 are type Z edges
;(assert (! (forall ((w point) (x point)) (=> (deleting y6 z5 w x) (or (intersection u1 v1 y6 w) (deleting y6 z5 x w)))) :named U9))
;(assert (! (forall ((w point) (x point)) (=> (deleting y6 z5 w x) (or (intersection u1 v1 y6 w) (intersection u1 v1 y6 x)))) :named U10))

;all edges deleting y6z7 are type Y edges
;(assert (! (forall ((w point) (x point)) (=> (deleting y6 z7 w x) (or (intersection u1 v1 w z7) (deleting y6 z7 x w)))) :named U11))
;(assert (! (forall ((w point) (x point)) (=> (deleting y6 z7 w x) (or (intersection u1 v1 w z7) (intersection u1 v1 x z7)))) :named U12))

;all edges deleting y8z7 are type Z edges
(assert (! (forall ((w point) (x point)) (=> (deleting y8 z7 w x) (or (intersection u1 v1 y8 w) (deleting y8 z7 x w)))) :named U13))
(assert (! (forall ((w point) (x point)) (=> (deleting y8 z7 w x) (or (intersection u1 v1 y8 w) (intersection u1 v1 y8 x)))) :named U14))

;all edges deleting y8z9 are type Y edges
(assert (! (forall ((w point) (x point)) (=> (deleting y8 z9 w x) (or (intersection u1 v1 w z9) (deleting y8 z9 x w)))) :named U15))
(assert (! (forall ((w point) (x point)) (=> (deleting y8 z9 w x) (or (intersection u1 v1 w z9) (intersection u1 v1 x z9)))) :named U16))

;all edges deleting y10z9 are type Z edges
(assert (! (forall ((w point) (x point)) (=> (deleting y10 z9 w x) (or (intersection u1 v1 y10 w) (deleting y10 z9 x w)))) :named U17))
(assert (! (forall ((w point) (x point)) (=> (deleting y10 z9 w x) (or (intersection u1 v1 y10 w) (intersection u1 v1 y10 x)))) :named U18))
...
(assert (! (inside y2 y4 z3 z5) :named Q23))

(assert (! (E y4 z7) :named Q31))
(assert (! (intersection u1 v1 y4 z7) :named Q32))
(assert (! (inside y2 y4 z3 z7) :named Q33))

(assert (! (E y8 z7) :named Q41))
(assert (! (intersection u1 v1 y8 z7) :named Q42))
(assert (! (inside y2 y4 z3 y8) :named Q43))
(assert (! (inside z3 z5 y4 y8) :named Q44))

(assert (! (deleting y8 z7 w8 x8) :named Q51))
(assert (! (intersection u1 v1 y8 w8) :named Q52))
(assert (! (inside y2 y4 z3 w8) :named Q53))

(assert (! (E y8 z9) :named Q61))
(assert (! (intersection u1 v1 y8 z9) :named Q62))
(assert (! (inside z7 w8 y8 z9) :named Q63))

(assert (! (E y10 z9) :named Q71))
(assert (! (intersection u1 v1 y10 z9) :named Q72))
(assert (! (inside z3 z5 y4 y10) :named Q73))
(assert (! (inside z7 z9 y8 y10) :named Q74))

(assert (! (deleting y10 z9 w11 x11) :named Q81))


(assert (! (not (intersection y4 z5 y8 z7)) :named Q101))
(assert (! (not (intersection y4 z5 y8 z9)) :named Q102))
(assert (! (not (intersection y4 z5 y10 z9)) :named Q103))

(assert (! (not (F w11 x11)) :named Q201))

(assert (! (not (inside y2 y4 z3 w11)) :named Q301))
