...
(assert (! (not (F w3 x3)) :named Q101))

(assert (! (not (inside z1 z3 y2 w3)) :named Q201))
(assert (! (not (inside z3 z1 y2 w3)) :named Q202))

(assert (! (not (intersection u1 v1 w3 x3)) :named Q301))
