...
(assert (! (deleting y4 w4 w5 x5) :named Q21))
(assert (! (deleting y4 w4 x5 w5) :named Q22))
(assert (! (intersection u1 v1 y4 w5) :named Q23))
(assert (! (intersection u1 v1 y4 x5) :named Q24))
(assert (! (inside z3 w4 y4 w5) :named Q25))

(assert (! (deleting y4 w5 w6 x6) :named Q31))

(assert (! (deleting y4 w6 w5 x5) :named Q41))


(assert (! (not (deleting y4 z3 w5 x4)) :named Q101))

(assert (! (not (deleting y4 z3 x5 x4)) :named Q111))
(assert (! (not (deleting y4 z3 x5 x6)) :named Q112))

(assert (! (not (F w4 x4)) :named Q201))

(assert (! (not (inside z3 w4 y4 x5)) :named Q301))
