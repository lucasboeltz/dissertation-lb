...
(assert (! (not (deleting w2 x1 x3 w3)) :named Q101))

(assert (! (not (deleting w1 x1 w3 x2)) :named Q201))
(assert (! (not (deleting w1 x1 w3 x3)) :named Q202))

(assert (! (not (intersection w3 x1 w2 x2)) :named Q301))

(assert (! (not (inside w1 x1 w2 w3)) :named Q401))
(assert (! (not (inside x1 w1 w2 w3)) :named Q402))

(assert (! (not (F w2 x2)) :named Q501))
