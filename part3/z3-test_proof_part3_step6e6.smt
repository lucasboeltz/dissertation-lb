...
(assert (! (deleting y2 z3 w3 x3) :named Q11))
(assert (! (intersection u1 v1 w3 z3) :named Q12))

(assert (! (deleting w3 z3 w4 x4) :named Q21))
(assert (! (intersection u1 v1 w4 z3) :named Q22))

(assert (! (E y4 z3) :named Q31))
(assert (! (intersection u1 v1 y4 z3) :named Q32))
(assert (! (inside z3 w4 w3 y4) :named Q33))

(assert (! (E y4 z4) :named Q41))
(assert (! (intersection u1 v1 y4 z4) :named Q42))
(assert (! (inside y2 y4 z3 z4) :named Q43))

(assert (! (deleting y4 z4 z3 x7) :named Q51))


(assert (! (not (deleting w3 z3 x4 w4)) :named Q101))

(assert (! (not (deleting y4 z4 x7 z3)) :named Q201))
