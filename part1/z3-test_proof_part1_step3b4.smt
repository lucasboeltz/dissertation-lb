...
(assert (! (intersection u1 v1 y2 w2) :named Q11))

(assert (! (deleting y2 w2 w3 x3) :named Q21))
(assert (! (deleting y2 w2 x3 w3) :named Q22))

(assert (! (intersection u1 v1 y2 w3) :named Q31))
(assert (! (intersection u1 v1 y2 x3) :named Q32))

(assert (! (inside x3 z1 y2 u1) :named Q41))

(assert (! (inside z1 w3 y2 u1) :named Q51))


(assert (! (not (inside w2 z1 y2 u1)) :named Q101))
(assert (! (not (inside w2 z1 y2 v1)) :named Q102))
(assert (! (not (inside z1 w2 y2 u1)) :named Q103))
(assert (! (not (inside z1 w2 y2 v1)) :named Q104))

(assert (! (not (inside w3 z1 y2 u1)) :named Q201))
