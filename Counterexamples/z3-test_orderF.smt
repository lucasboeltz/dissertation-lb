...
(assert (! (intersection u1 v1 w1 w2) :named Q12))

(assert (! (deleting w1 w2 w3 x3) :named Q21))
(assert (! (intersection u1 v1 w1 w3) :named Q22))

(assert (! (deleting w1 x1 x3 w3) :named Q31))
(assert (! (intersection u1 v1 w1 x3) :named Q32))


(assert (! (not (deleting w1 x1 w3 x3)) :named Q101))

(assert (! (not (deleting w1 w2 x3 w3)) :named Q111))
