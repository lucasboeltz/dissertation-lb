...
(assert (! (deleting y6 z7 y8 x7) :named Q31))
(assert (! (intersection u1 v1 y8 z7) :named Q32))

(assert (! (E y8 z9) :named Q41))
(assert (! (intersection u1 v1 y8 z9) :named Q42))
(assert (! (inside y8 y6 z7 z9) :named Q43))

(assert (! (deleting y8 z9 w9 x9) :named Q51))
(assert (! (intersection u1 v1 w9 z9) :named Q52))

(assert (! (inside y8 w9 z9 y9) :named Q61))

(assert (! (intersection y2 z3 y9 z9) :named Q71))
