...
(assert (! (not (intersection w3 x3 w4 z3)) :named Q301))

(assert (! (not (deleting w3 z3 x4 w4)) :named Q401))

(assert (! (not (inside y2 w3 z3 w4)) :named Q501))
(assert (! (not (inside w3 y2 z3 w4)) :named Q502))
