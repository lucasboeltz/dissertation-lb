...
(assert (! (not (deleting y4 z3 w5 x5)) :named Q102))
(assert (! (not (deleting y4 z3 x5 x4)) :named Q103))
(assert (! (not (deleting y4 z3 x5 w5)) :named Q104))


(assert (! (not (F w4 x4)) :named Q201))


(assert (! (not (inside z3 w4 y4 w5)) :named Q501))
(assert (! (not (inside w4 z3 y4 w5)) :named Q502))
(assert (! (not (inside z3 w4 y4 x5)) :named Q503))
(assert (! (not (inside w4 z3 y4 x5)) :named Q504))
