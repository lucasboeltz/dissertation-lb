...
(assert (! (inside y4 y2 z3 z4) :named Q33))

(assert (! (deleting y4 z4 w6 x6) :named Q41))


(assert (! (not (F w3 x3)) :named Q101))
(assert (! (not (intersection w3 x3 y4 z3)) :named Q111))

(assert (! (not (deleting y4 z4 x6 w6)) :named Q201))

(assert (! (not (inside y4 y2 z3 w6)) :named Q301))
(assert (! (not (intersection y4 y2 z4 w6)) :named Q311))
