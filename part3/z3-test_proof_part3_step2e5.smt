...
(assert (! (E y3 z3) :named Q41))
(assert (! (intersection u1 v1 y3 z3) :named Q42))
(assert (! (inside z3 z1 y2 y3) :named Q43))

(assert (! (deleting y3 z3 y2 x6) :named Q51))


(assert (! (not (deleting y2 w2 x3 w3)) :named Q101))

(assert (! (not (deleting y3 z3 x6 y2)) :named Q201))
