...
(assert (! (intersection u1 v1 w3 w2) :named Q31))
(assert (! (intersection u1 v1 x3 w2) :named Q32))

(assert (! (inside x3 y2 w2 u1) :named Q41))

(assert (! (inside w3 y2 w2 v1) :named Q51))
...
(assert (! (not (inside w3 y2 w2 u1)) :named Q201))
