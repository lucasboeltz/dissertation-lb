...
(declare-const w4 point)
(declare-const x4 point)
...
(assert (! (deleting y2 z3 w3 x3) :named Q21))
(assert (! (deleting y2 z3 x3 w3) :named Q22))
(assert (! (intersection u1 v1 w3 z3) :named Q23))
(assert (! (intersection u1 v1 x3 z3) :named Q24))
(assert (! (inside z3 z1 y2 w3) :named Q25))

(assert (! (deleting w3 z3 w4 x4) :named Q31))
(assert (! (intersection u1 v1 w4 z3) :named Q32))

(assert (! (deleting w4 z3 w3 x3) :named Q41))


(assert (! (not (deleting y2 z3 x3 x4)) :named Q101))

(assert (! (not (deleting w3 z3 y2 x4)) :named Q201))
