...
;(assert (! (deleting u1 v1 w2 x1) :named Q12))

(assert (! (deleting w2 x1 w3 x3) :named Q21))
;(assert (! (deleting u1 v1 w3 x1) :named Q22))

(assert (! (deleting w2 x1 x3 w3) :named Q31))
;(assert (! (deleting u1 v1 w3 x1) :named Q32))


(assert (! (not (deleting w1 x1 w3 x2)) :named Q101))
(assert (! (not (deleting w1 x1 w3 x3)) :named Q102))
(assert (! (not (deleting w1 x1 x3 x2)) :named Q103))
(assert (! (not (deleting w1 x1 x3 w3)) :named Q104))

(assert (! (not (inside w1 x1 w2 w3)) :named Q111))
(assert (! (not (inside w1 x1 w2 x3)) :named Q112))
(assert (! (not (inside x1 w1 w2 w3)) :named Q113))
(assert (! (not (inside x1 w1 w2 x3)) :named Q114))
