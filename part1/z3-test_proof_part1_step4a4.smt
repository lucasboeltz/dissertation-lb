...
(assert (! (intersection u1 v1 y z) :named Q1))

(assert (! (intersection u1 v1 y w2) :named Q11))

(assert (! (inside w2 z y w3) :named Q21))

(assert (! (inside y w3 w2 u1) :named Q31))


(assert (! (not (inside w2 z y u1)) :named Q101))
(assert (! (not (inside w2 z y v1)) :named Q102))
(assert (! (not (inside z w2 y u1)) :named Q103))
(assert (! (not (inside z w2 y v1)) :named Q104))
