...
(assert (! (deleting y2 z1 w2 x2) :named Q11))
(assert (! (intersection u1 v1 y2 w2) :named Q12))

(assert (! (deleting y2 w2 z3 x3) :named Q21))
(assert (! (intersection u1 v1 y2 z3) :named Q22))

(assert (! (E y3 z3) :named Q31))
(assert (! (intersection u1 v1 y3 z3) :named Q32))
(assert (! (inside z3 z1 y2 y3) :named Q33))

(assert (! (deleting y3 z3 y2 x5) :named Q41))


(assert (! (not (deleting y2 w2 x3 z3)) :named Q101))

(assert (! (not (deleting y3 z3 x5 y2)) :named Q201))
