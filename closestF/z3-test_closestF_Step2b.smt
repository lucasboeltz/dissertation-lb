...
(assert (! (F w1 x2) :named Q21))
(assert (! (intersection u1 p1 w1 x2) :named Q22))


(assert (! (not (inside u1 p1 x1 x2)) :named Q101))
(assert (! (not (inside u1 x1 p1 x2)) :named Q102))

(assert (! (not (intersection u1 x1 w1 x2)) :named Q201))

(assert (! (not (= x2 x1)) :named Q301))
