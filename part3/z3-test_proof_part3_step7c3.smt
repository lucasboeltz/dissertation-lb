...
(assert (! (E y4 w4) :named Q31))
(assert (! (intersection u1 v1 y4 w4) :named Q32))

(assert (! (inside w4 z3 y4 z4) :named Q41))

(assert (! (intersection y2 z1 y4 z4) :named Q51))


(assert (! (not (intersection y2 z1 y4 w4)) :named Q101))

(assert (! (not (intersection y2 z3 y4 w4)) :named Q111))

(assert (! (not (inside y2 y4 z3 w4)) :named Q201))
