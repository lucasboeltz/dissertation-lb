...
(assert (! (deleting u1 v1 y2 z1) :named Q1))

(assert (! (deleting y2 z1 w2 x2) :named Q11))
(assert (! (intersection u1 v1 y2 w2) :named Q12))

(assert (! (deleting y2 w2 w3 x3) :named Q21))
(assert (! (intersection u1 v1 y2 w3) :named Q22))

(assert (! (E y2 z3) :named Q31))
(assert (! (intersection u1 v1 y2 z3) :named Q32))
(assert (! (inside y2 w2 w3 z3) :named Q33))

(assert (! (deleting y2 z3 w5 x5) :named Q41))

(assert (! (inside w5 y2 z3 z1) :named Q51))


(assert (! (not (deleting y2 w2 x3 w3)) :named Q101))
