...
(assert (! (deleting y4 z3 w5 x5) :named Q31))
(assert (! (deleting y4 z3 x5 w5) :named Q32))
(assert (! (intersection u1 v1 y4 w5) :named Q33))
(assert (! (intersection u1 v1 y4 x5) :named Q34))
(assert (! (inside y4 y2 z3 w5) :named Q35))

(assert (! (deleting y4 w5 w6 x6) :named Q41))

(assert (! (deleting y4 w6 w5 x5) :named Q51))



(assert (! (not (F w3 x3)) :named Q101))

(assert (! (not (inside y4 y2 z3 x5)) :named Q201))
