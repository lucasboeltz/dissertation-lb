...
(assert (! (deleting w1 x1 w2 x2) :named Q1))
(assert (! (deleting w1 w2 w3 x3) :named Q2))
(assert (! (deleting w1 w3 w4 x4) :named Q3))
(assert (! (deleting w1 x1 x4 w4) :named Q4))


(assert (! (not (deleting w1 x1 w3 x3)) :named Q101))
(assert (! (not (deleting w1 w2 x3 w3)) :named Q102))

(assert (! (not (deleting w1 x1 w4 x4)) :named Q111))
(assert (! (not (deleting w1 w3 x4 w4)) :named Q112))


(assert (! (not (F w2 x2)) :named Q121))
