...
(assert (! (E y6 w6) :named Q31))
(assert (! (intersection u1 v1 y6 w6) :named Q32))

(assert (! (inside z5 w6 y6 z6) :named Q41))

(assert (! (intersection y2 z1 y6 z6) :named Q51))


(assert (! (not (intersection y2 z1 y6 z5)) :named Q101))
(assert (! (not (intersection y2 z1 y6 w6)) :named Q102))

(assert (! (not (intersection y2 z3 y6 z5)) :named Q111))
(assert (! (not (intersection y2 z3 y6 w6)) :named Q112))


(assert (! (not (inside z5 w6 y6 z1)) :named Q201))
