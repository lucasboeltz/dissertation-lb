...
(assert (! (intersection u1 v1 y2 z1) :named Q1))

(assert (! (intersection u1 v1 y2 z3) :named Q11))

(assert (! (intersection u1 v1 y3 z3) :named Q21))
(assert (! (inside z3 z1 y2 y3) :named Q22))

(assert (! (inside z3 z1 y2 w4) :named Q31))


(assert (! (not (intersection u1 v1 w4 z3)) :named Q101))
(assert (! (not (intersection u1 v1 y3 w4)) :named Q102))

(assert (! (not (inside z3 z1 y2 u1)) :named Q201))
(assert (! (not (inside z3 z1 y2 v1)) :named Q202))
