...
;w2x2 is in F and deleting w1v1
...
;x2w2 is not deleting w1v1
(assert (! (not (deleting w1 v1 x2 w2)) :named Q201))

;w2 is not inside a triangle formed by u1,v1 and w1
(assert (! (not (inside u1 v1 w1 w2)) :named Q301))
(assert (! (not (inside v1 u1 w1 w2)) :named Q302))
