...
(assert (! (deleting y4 z4 x5 w5) :named Q32))

(assert (! (intersection u1 v1 y4 w5) :named Q41))
(assert (! (inside y2 y4 z3 w5) :named Q42))

(assert (! (intersection y2 z3 y4 w5) :named Q51))


(assert (! (not (intersection y2 z3 y4 z4)) :named Q101))
