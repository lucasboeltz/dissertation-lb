...
(declare-const c1 point)
(declare-const c2 point)
...
(assert (! (=> (F u1 v1) (left u1 v1 w1)) :named W1))
(assert (! (=> (F u1 v1) (left v1 u1 x1)) :named W2))
(assert (! (=> (F u1 v1) (left w1 x1 v1)) :named W3))
(assert (! (=> (F u1 v1) (left x1 w1 u1)) :named W4))
(assert (! (F u1 v1) :named W5))
(assert (! (E w1 x1) :named W6))



;w1x1 is the edge with intersection point closest to v1 intersecting with u1v1
(assert (! (forall ((y point) (z point)) (=> (and (F y z) (intersection w1 x1 y z)) (not (intersection u1 w1 y z)))) :named X1))
(assert (! (forall ((y point) (z point)) (=> (and (F y z) (intersection w1 x1 y z)) (not (intersection v1 w1 y z)))) :named X2))
(assert (! (forall ((y point) (z point)) (=> (and (F y z) (intersection w1 x1 y z)) (not (inside u1 v1 w1 y)))) :named X3))
(assert (! (forall ((y point) (z point)) (=> (and (F y z) (intersection w1 x1 y z)) (not (inside u1 v1 w1 z)))) :named X4))

;condition for edges on the convex hull
(assert (! (= (next w1) nil) :named Y0))
(assert (! (forall ((y point) (i1 point)) (=> (and (V y) (left u1 v1 y) (left x1 w1 y)) (or (= i1 nil) (= (next i1) nil) (= y i1) (= y (next i1)) (left i1 (next i1) y) (left y (next i1) i1)))) :named Y1))
(assert (! (forall ((y point) (i1 point)) (=> (and (V y) (left u1 v1 y) (left x1 w1 y)) (or (= i1 nil) (= (next i1) nil) (= y i1) (= y (next i1)) (left i1 (next i1) y) (left (next i1) y i1)))) :named Y2))
(assert (! (forall ((y point) (i1 point)) (=> (and (V y) (left u1 v1 y) (left x1 w1 y) (left (next i1) i1 y)) (or (= i1 nil) (= (next i1) nil) (= y i1) (= y (next i1)) (left y (next i1) i1)))) :named Y3))
(assert (! (forall ((y point) (i1 point)) (=> (and (V y) (left u1 v1 y) (left x1 w1 y) (left (next i1) i1 y)) (or (= i1 nil) (= (next i1) nil) (= y i1) (= y (next i1)) (left (next i1) y i1)))) :named Y4))

(assert (! (forall ((i1 point))  (or (= i1 nil) (= (next i1) nil) (inside u1 v1 w1 (next i1)) (= (next i1) w1))) :named Y11))
(assert (! (forall ((i1 point))  (or (= i1 nil) (= (next i1) nil) (inside u1 x1 w1 i1) (= i1 u1))) :named Y12))
(assert (! (forall ((i1 point))  (or (E i1 (next i1)) (= i1 nil) (= (next i1) nil))) :named Y13))

(assert (! (forall ((i1 point)) (or (= i1 nil) (= (next i1) nil) (inside u1 v1 (next i1) i1) (= i1 u1))) :named Y14))
(assert (! (forall ((i1 point)) (or (= i1 nil) (= (next i1) nil) (inside u1 x1 (next i1) i1) (= i1 u1))) :named Y15))
(assert (! (forall ((i1 point)) (or (= i1 nil) (= (next i1) nil) (inside v1 w1 i1 (next i1)) (= (next i1) w1))) :named Y16))
(assert (! (forall ((i1 point)) (or (= i1 nil) (= (next i1) nil) (inside x1 w1 i1 (next i1)) (= (next i1) w1))) :named Y17))
...
(assert (! (= c2 (next c1)) :named Q1))

(assert (! (intersection c1 c2 a b) :named Q11))
(assert (! (F a b) :named Q12))


(assert (! (not (= nil c1)) :named Q101))
(assert (! (not (= nil c2)) :named Q102))
