...
(assert (! (not (intersection w4 x4 y4 z5)) :named Q111))

(assert (! (not (deleting y5 z5 x7 w7)) :named Q201))

(assert (! (not (inside z3 z5 y4 w7)) :named Q301))
(assert (! (not (intersection z3 z5 y5 w7)) :named Q311))
