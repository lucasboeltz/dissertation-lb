...
(assert (! (deleting y4 z3 w4 x4) :named Q21))
(assert (! (deleting y4 z3 x4 w4) :named Q22))
(assert (! (intersection u1 v1 y4 w4) :named Q23))
(assert (! (intersection u1 v1 y4 x4) :named Q24))
(assert (! (inside y2 y4 z3 w4) :named Q25))

(assert (! (deleting y4 w4 w5 x5) :named Q31))
(assert (! (intersection u1 v1 y4 w5) :named Q32))

(assert (! (deleting y4 w5 w4 x4) :named Q41))


(assert (! (not (deleting y4 z3 x4 x5)) :named Q101))

(assert (! (not (deleting y4 w4 z3 x5)) :named Q201))
