...
(assert (! (deleting y6 z5 z7 x6) :named Q31))
(assert (! (intersection u1 v1 y6 z7) :named Q32))

(assert (! (E y8 z7) :named Q41))
(assert (! (intersection u1 v1 y8 z7) :named Q42))
(assert (! (inside z5 z7 y6 y8) :named Q43))

(assert (! (deleting y8 z7 w8 x8) :named Q51))
(assert (! (intersection u1 v1 y8 w8) :named Q52))

(assert (! (inside w8 z7 y8 z8) :named Q61))

(assert (! (intersection y2 z1 y8 z8) :named Q71))
...
(assert (! (not (F z7 x6)) :named Q201))

(assert (! (not (F w8 x8)) :named Q301))
