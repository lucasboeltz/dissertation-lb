...
(assert (! (deleting y4 z3 w4 x4) :named Q31))


(assert (! (not (F w4 x4)) :named Q101))

(assert (! (not (inside y2 y4 z3 w4)) :named Q201))

(assert (! (not (inside z1 z3 y4 w4)) :named Q301))
(assert (! (not (intersection z1 z3 y4 w4)) :named Q311))
