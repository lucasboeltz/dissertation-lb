...
(assert (! (deleting w1 x1 w2 x2) :named Q11))
(assert (! (F w2 x2) :named Q12))
;(assert (! (intersection u1 v1 w2 x1) :named Q13))

(assert (! (deleting w2 x1 w3 x3) :named Q21))
;(assert (! (intersection u1 v1 w3 x1) :named Q22))

(assert (! (deleting w3 x1 w4 x4) :named Q31))
;(assert (! (intersection u1 v1 w4 x1) :named Q32))

(assert (! (not (deleting w1 x1 w3 x3)) :named Q101))
;(assert (! (not (deleting w1 x1 x3 w3)) :named Q102))


(assert (! (not (deleting w2 x1 w4 x3)) :named Q201))
(assert (! (not (deleting w2 x1 w4 x4)) :named Q202))

(assert (! (not (deleting w3 x1 x4 w4)) :named Q211))

(assert (! (not (intersection w3 x1 w2 x2)) :named Q301))

(assert (! (not (intersection w4 x1 w3 x3)) :named Q311))

(assert (! (not (inside w1 x1 w2 w3)) :named Q401))
(assert (! (not (inside w1 x1 w2 x3)) :named Q402))
(assert (! (not (inside x1 w1 w2 w3)) :named Q403))
(assert (! (not (inside x1 w1 w2 x3)) :named Q404))

(assert (! (not (inside x1 w2 w3 w4)) :named Q601))
(assert (! (not (inside x1 w2 w3 x4)) :named Q602))
(assert (! (not (inside x1 w3 w2 w4)) :named Q603))
(assert (! (not (inside x1 w3 w2 x4)) :named Q604))
