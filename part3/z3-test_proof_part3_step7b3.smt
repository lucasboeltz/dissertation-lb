...
(assert (! (E y4 z3) :named Q2))
(assert (! (intersection u1 v1 y4 z3) :named Q3))

(assert (! (deleting y4 z3 w4 x4) :named Q11))

(assert (! (E y4 z4) :named Q21))
(assert (! (intersection u1 v1 y4 z4) :named Q22))
(assert (! (inside z3 w4 y4 z4) :named Q23))

(assert (! (deleting y4 z4 w6 x6) :named Q31))
(assert (! (deleting y4 z4 x6 w6) :named Q32))


(assert (! (not (deleting y4 z3 w6 x4)) :named Q101))
(assert (! (not (deleting y4 z3 x6 x4)) :named Q102))
(assert (! (not (deleting y4 z3 w6 x6)) :named Q103))
(assert (! (not (deleting y4 z3 x6 w6)) :named Q104))

(assert (! (not (F w4 x4)) :named Q201))

(assert (! (not (intersection w4 x4 y4 z4)) :named Q301))
(assert (! (not (intersection w4 x4 y4 w6)) :named Q311))

(assert (! (not (inside z3 w4 y4 w6)) :named Q401))
(assert (! (not (inside z3 w4 y4 x6)) :named Q402))
