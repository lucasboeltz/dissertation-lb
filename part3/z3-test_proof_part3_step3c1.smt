...
(assert (! (deleting y4 z5 w5 x5) :named Q31))

(assert (! (intersection y2 z3 w5 z5) :named Q41))


(assert (! (not (intersection y2 z3 y4 z5)) :named Q101))

(assert (! (not (F w5 x5)) :named Q201))
