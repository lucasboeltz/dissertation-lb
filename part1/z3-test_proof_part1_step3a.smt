...
(assert (! (not (intersection u1 v1 y2 w3)) :named Q201))
(assert (! (not (intersection u1 v1 y2 x3)) :named Q202))
(assert (! (not (intersection u1 v1 w3 w2)) :named Q203))
(assert (! (not (intersection u1 v1 x3 w2)) :named Q204))
