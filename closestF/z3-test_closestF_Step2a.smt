...
(assert (! (left u1 v1 p1) :named Q1))
(assert (! (left v1 u1 p1) :named Q2))
(assert (! (left w1 x1 p1) :named Q3))
(assert (! (left x1 w1 p1) :named Q4))


(assert (! (F w1 x1) :named Q11))
(assert (! (deleting u1 v1 w1 x1) :named Q12))

(assert (! (F w2 x2) :named Q21))
(assert (! (intersection u1 p1 w2 x2) :named Q22))

(assert (! (not (inside u1 p1 w1 w2)) :named Q101))
(assert (! (not (inside u1 p1 w1 x2)) :named Q102))
(assert (! (not (inside u1 w1 p1 w2)) :named Q103))
(assert (! (not (inside u1 w1 p1 x2)) :named Q104))

(assert (! (not (intersection w1 u1 w2 x2)) :named Q201))

(assert (! (not (= w2 w1)) :named Q301))
(assert (! (not (= x2 w1)) :named Q302))
