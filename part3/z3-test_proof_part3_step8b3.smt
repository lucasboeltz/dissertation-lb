...
(assert (! (E y4 z5) :named Q11))
(assert (! (E z3 z5) :named Q12))
(assert (! (intersection u1 v1 y4 z5) :named Q13))

(assert (! (E y5 z5) :named Q21))
(assert (! (inside z3 z5 y4 y5) :named Q22))
(assert (! (intersection u1 v1 y5 z5) :named Q23))

(assert (! (deleting y5 z5 w6 x6) :named Q31))
(assert (! (deleting y5 z5 x6 w6) :named Q32))


(assert (! (not (inside z3 z5 y4 w6)) :named Q101))
(assert (! (not (inside z3 z5 y4 x6)) :named Q102))
