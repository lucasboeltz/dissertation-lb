...
(assert (! (E y4 z3) :named Q11))
(assert (! (intersection u1 v1 y4 z3) :named Q12))
...
(assert (! (inside y4 y6 z5 z7) :named Q43))

(assert (! (deleting y6 z7 w7 x7) :named Q51))

(assert (! (intersection y2 z3 w7 z7) :named Q61))


(assert (! (not (intersection y2 z3 y6 z5)) :named Q101))
(assert (! (not (intersection y2 z3 y6 z7)) :named Q102))

(assert (! (not (intersection y4 z3 y6 z5)) :named Q111))
(assert (! (not (intersection y4 z3 y6 z7)) :named Q112))
