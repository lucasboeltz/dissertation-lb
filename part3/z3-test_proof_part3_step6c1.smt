...
(assert (! (inside y2 y4 z3 z4) :named Q23))

(assert (! (deleting y4 z4 w5 x5) :named Q31))


(assert (! (not (deleting y4 z3 w5 x5)) :named Q101))

(assert (! (not (deleting y4 z4 x5 w5)) :named Q201))
(assert (! (not (deleting y4 z4 z3 x5)) :named Q211))
(assert (! (not (inside y2 y4 z3 w5)) :named Q221))

(assert (! (not (intersection u1 v1 w5 z4)) :named Q301))
