...
(assert (! (inside y4 y2 z3 z4) :named Q23))
...
(assert (! (not (F y4 x3)) :named Q201))

(assert (! (not (deleting y4 z4 x5 w5)) :named Q301))

(assert (! (not (inside y4 y2 z3 w5)) :named Q401))
(assert (! (not (intersection y4 y2 w5 z4)) :named Q411))
