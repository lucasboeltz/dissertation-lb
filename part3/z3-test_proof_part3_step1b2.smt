...
(assert (! (not (inside z1 z3 y2 w3)) :named Q101))
(assert (! (not (inside z3 z1 y2 w3)) :named Q102))
(assert (! (not (inside z1 z3 y2 x3)) :named Q103))
(assert (! (not (inside z3 z1 y2 x3)) :named Q104))
